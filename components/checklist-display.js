...
export class ChecklistDisplay {
    constructor(options) {
        ...
        this.categoryNames = {
            ...
            hotel_camping_combination: '🏨⛺ Hotel to Camping',
            rental_family_combination: '🏠👨‍👩‍👧‍👦 Rental to Family',
            international_hotel_transfer: '🌍🏨 International Hotel Transfer',
            ...
            car_emergency: '🧰 Car Emergency Kit',
            // Transport specific:
            ...
            wild_camping_essentials: '🏕️ Wild Camping',
        ...
        this.categoryIcons = {
            ...
            flight_to_car_transition: '✈️',
flight_to_train_transition: '✈️',
ferry_car_coordination: '⛴️',
hotel_camping_combination: '🏨',
rental_family_combination: '🏠',
international_hotel_transfer: '🌍',
car_camping_combo: '🚗',
budget_flight_security: '✈️',
train_family_visit: '🚊',
ferry_hotel_coastal: '⛴️',
high_complexity_management: '⚡',
multi_accommodation_coordination: '🏨',
long_flight_comfort: '🛋️',
long_drive_comfort: '🚗',
rental_car_requirements: '🚗',
overnight_train_comfort: '🚊',
overnight_ferry_comfort: '⛴️',
cooking_essentials: '🍳',
laundry_items: '🧺',
wild_camping_essentials: '🏕️',
cold_weather_camping: '❄️',
